        ...
        <Box component={"div"}>
            <Box component={"div"} sx={{ display : "flex", flexDirection : "row", justifyContent : "space-between", alignItems : "center", paddingX : { xs : 2, sm  : 2, md : 5, lg : 5 }, paddingY : 1,/*borderTop : 1, borderColor : "#d7d7d7"*/ }}>
                ...
                <Box component={motion.div} sx={{ display : "flex", flexDirection : "row", justifyContent : "space-evenly", alignItems : "center", paddingLeft : { xs : 2, sm : 2 } }} initial={{ x : '100vw' }} animate={{ x : 0 }} transition={{ delay : 0.6, type : 'tween', duration : 1  }}>
                    <Link href={"/about"}><Typography sx={{ color : theme.palette.primary.main, fontSize : { xs : "16px", sm : "16px", md : "18px",lg : "18px" }, textAlign : { xs : "center", sm : "center" }, lineHeight : { xs : "25px", sm : "26px", md : "36px", lg : "36px" }, letterSpacing : "1px", textTransform : "uppercase", cursor : "pointer", ':hover' : { color : "#6d6e71" } }}>About Us</Typography></Link>
                    <Link href={"#"}><Typography variant={"subtitle1"} sx={{ marginX : 2, color : theme.palette.primary.main,textAlign : { xs : "center", sm : "center" }, fontSize : { xs : "16px", sm : "16px", md : "18px",lg : "18px" }, lineHeight : { xs : "25px", sm : "26px", md : "36px", lg : "36px" }, letterSpacing : "1px", fontWeight : 500, textTransform : "uppercase", cursor : "pointer", ':hover' : { color : "#6d6e71" } }}>Privacy Policy</Typography></Link>
            ...
            <Box component={"div"} sx={{ backgroundColor: theme.palette.secondary.main, display : "flex", flexDirection : "row", justifyContent : "space-between", alignItems : "center", paddingX: 3, paddingY : 4 }}>
                <Box sx={{ display : "flex", flexDirection : "row" }} component={motion.div}  initial={{ x : '-100vw' }} animate={{ x : 0 }} transition={{ delay : 0.6, type : 'tween', duration : 1  }}>
                    ...
                    <TwitterIcon fontSize={"large"} sx={{ color : "#00acee", ":hover" : { color : theme.palette.primary.main }, cursor : "pointer" }}/>
                </Box>
                <Box component={motion.div}  initial={{ x : '100vw' }} animate={{ x : 0 }} transition={{ delay : 0.6, type : 'tween', duration : 1  }}>
