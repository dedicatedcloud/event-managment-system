          ...
          <Box component={"div"}>
              ...
              <Box component={"div"} sx={{ display : "flex", flexDirection : "row", justifyContent : "center", alignItems : "center", flexWrap : "wrap", backgroundColor : "rgb(255,255,255)", paddingTop : "5rem", paddingBottom : "5rem", overflow : "hidden" }}>
                  <Box sx={{ textAlign : "center", width : "22rem", paddingBottom : "1rem" }}  component={motion.div} initial={{ x : '-100vw' }} animate={{ x : 0 }} transition={{ delay : 0.4, duration : 1, type : 'tween' }}>
                      <Typography sx={{ color: theme.palette.primary.main, backgroundColor : "rgba(0, 0, 0, 0)", fontSize : "20px", lineHeight : "56px", verticalAlign: "baseline", letterSpacing: "2px", wordSpacing: "0px", fontWeight: 600, fontStyle : "normal", fontVariant : "normal", textTransform : "uppercase", textDecoration : "rgb(0, 0, 0)", textIndent : "0px" }}>Weddings</Typography>
                  ...
                  <Box sx={{ textAlign : "center", width : "22rem", marginX : 3, paddingBottom : "1rem" }} component={motion.div} initial={{ y : '100vw' }} animate={{ y : 0 }} transition={{ delay : 0.4, duration : 1, type : 'tween' }}>
                      <Typography sx={{ color: theme.palette.primary.main, backgroundColor : "rgba(0, 0, 0, 0)", fontSize : "20px", lineHeight : "56px", verticalAlign: "baseline", letterSpacing: "2px", wordSpacing: "0px", fontWeight: 600, fontStyle : "normal", fontVariant : "normal", textTransform : "uppercase", textDecoration : "rgb(0, 0, 0)", textIndent : "0px" }}>Corporate Events</Typography>
                  ...
                  <Box sx={{ textAlign : "center", width : "22rem" }}  component={motion.div} initial={{ x : '100vw' }} animate={{ x : 0 }} transition={{ delay : 0.4, duration : 1, type : 'tween' }}>
                       <Typography sx={{ color: theme.palette.primary.main, backgroundColor : "rgba(0, 0, 0, 0)", fontSize : "20px", lineHeight : "56px", verticalAlign: "baseline", letterSpacing: "2px", wordSpacing: "0px", fontWeight: 600, fontStyle : "normal", fontVariant : "normal", textTransform : "uppercase", textDecoration : "rgb(0, 0, 0)", textIndent : "0px" }}>Social Gatherings</Typography>
